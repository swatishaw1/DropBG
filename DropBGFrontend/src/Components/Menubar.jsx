        ...
        <nav className="bg-white px-8 py-4 flex justify-between items-center">
            <Link className="flex item-center space-x-2" to="/">
                ...
                <span className="text-2xl font-semibold text-indigo-700 cursor-pointer">
                    DropBG<span className="text-gray-400 cursor-pointer"> - Drop Your Image, Get Magic.</span>
                </span>
            </Link>
            <div className="hidden md:flex items-center space-x-4">
                <SignedOut>
                    ...
                    <button className="bg-gray-100 hover:bg-gray-200 text-gray-700 font-medium px-4 py-2 rounded-full transition-all" onClick={openRegister}>Sign Up</button>
                </SignedOut>
                <SignedIn>
            ...
            {menuOpen && (
                <div className="absolute top-16 right-8 bg-white shadow-md rounded-md flex flex-col space-y-4 p-4 w-40">
                    ...
                    <SignedIn>
                        ...
                        <div>
                            <UserButton className="gap-5"/> Hi, {user?.firstName}
                        </div>
                    </SignedIn>
                </div>
            )}
